  ...
  return (
    <div className="font-sans text-slate-800 antialiased overflow-hidden py-12">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-16 mb-16 text-center md:text-left">
        <div className="inline-block px-4 py-1.5 bg-[#fcd400]/20 text-[#6e5c00] rounded-sm mb-6 font-sans text-xs font-extrabold uppercase tracking-widest">
          NOS OFFRES EXCLUSIVES
        </div>
        <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black text-[#0d1c32] mb-6 leading-tight max-w-4xl tracking-tighter">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-16 grid grid-cols-1 md:grid-cols-12 gap-8 mb-24">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-[3px] bg-[#fcd400]" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-4">
            <div className="space-y-4 max-w-md">
              ...
              <h3 className="font-display text-2xl font-black text-[#0d1c32]">{weddingEvent.title}</h3>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <h3 className="font-display text-xl font-black text-[#0d1c32]">{birthdayEvent.title}</h3>
        ...
        <div 
          ...
          className="md:col-span-6 bg-[#0d1c32] text-white p-8 md:p-10 flex flex-col justify-between h-[420px] relative transition-all duration-300 cursor-pointer text-left group overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-[3px] bg-[#fcd400]" />
          
          <div className="space-y-4">
            <span className="p-3 bg-slate-800 border border-slate-700 text-[#fcd400] rounded-sm inline-block">
          ...
          <div className="flex justify-between items-center mt-6">
            <span className="font-display text-2xl font-black text-[#fcd400] tracking-tight">
              {professionalEvent.formattedPrice}
            </span>
            <button className="bg-[#fcd400] text-[#0d1c32] font-sans font-bold text-xs uppercase tracking-wider py-3 px-6 rounded-sm hover:-translate-y-0.5 active:translate-y-0 transition-transform duration-200">
              DÉCOUVRIR
            </button>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div className="space-y-4">
              ...
              <h3 className="font-display text-2xl font-black text-[#0d1c32]">{galaEvent.title}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-16 mb-24">
        <div className="bg-slate-100 border border-slate-200 rounded-sm p-8 md:p-12 text-center relative overflow-hidden">
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            ...
            <h4 className="font-display text-xl md:text-2xl font-black text-[#0d1c32]">
            ...
            <div className="pt-4 flex justify-center">
              <a 
                ...
                className="inline-flex items-center gap-3 text-lg sm:text-xl font-bold text-[#0d1c32] hover:text-[#705d00] transition-colors"
